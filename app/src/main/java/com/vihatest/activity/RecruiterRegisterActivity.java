...
public class RecruiterRegisterActivity extends AppCompatActivity  implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validateName() && validateLastName() && validateMobile() && validateEmailAddress() && validatePassword() && validateCfmPassword() && validateProfileType()) {
                    ...
                    signup_bundle.putBoolean("IS_RECRIUTER", true);
                    Intent intent = new Intent(RecruiterRegisterActivity.this, EmailVerificationActivity.class);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mainIntent = new Intent(RecruiterRegisterActivity.this, RecruiterLoginActivity.class);
    ...
    private boolean validateName() {
        ...
        if (name.length() < 2) {
            edtFirstName.setError("Please enter proper first nam");
